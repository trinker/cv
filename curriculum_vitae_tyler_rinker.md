...
&nbsp;&nbsp;&nbsp; Ph.D., [*Major*: Curriculum, Instruction, & the Science of Learning](http://gse.buffalo.edu/programs/cisl), *Expected:* Summer 2015     
&nbsp;&nbsp;&nbsp; [*Concentration*: Reading Educations](http://gse.buffalo.edu/programs/cisl/reading)     
&nbsp;&nbsp;&nbsp; Thesis Topic: *Graphical discourse analysis: Data visualization as a tool for analyzing classroom discourse*    
...
Shanahan, L. E., Tochelli, A. L., & Rinker, T. W. (revise and resubmit). Video study group reflection conversations: An analysis of inservice teachers' patterns of verbal interactions. *Journal of the Learning Sciences*. Manuscript submitted for publication.
    
McVee, M. B., McGrath, K., & Rinker, T. W. (revise and resubmit). A phenomenological study of narrative interviews with parents of struggling readers: Bringing parent voices into the academy. *Research Reading Quarterly*. Manuscript submitted for publication.
...
<div style="width: 100%;">
    ...
    <div style="width: 80%;text-align:right;"> 2014-2015 </div>
    <div style="margin-left: 14.5%; width: 30%; float: left;"> William C. Eller Memorial Scholarship </div>
    <div style="width: 80%;text-align:right;"> 2012-2013 </div> 
    <div style="margin-left: 14.5%; width: 40%; float: left;"> GSE Student Research Symposium: Best Research Poster </div>
...
O'Byrne, W. I., Stahl, N. A., Reinking, D., Dooley, C. D., Bass, T., Johnson, L. L., ... Rinker, T. W. (2014, December). <em>Professors, we need you!!!: Public intellectuals, advocacy, and activism</em>. (Presentation for the Literacy Research Association Annual Conference).
...
<h3 style="margin-left:49px;"> University Presentations: Invited </h3>
...
Rinker, T. W. (2014). [qdapRegex: Regular Expression Removal, Extraction, and Replacement Tools](http://cran.r-project.org/web/packages/qdapRegex/index.html). University at Buffalo.  Buffalo, New York. <http://github.com/trinker/qdapRegex>

Rinker, T. W. (2014). [qdapTools: Tools for the qdap Package](http://cran.r-project.org/web/packages/qdapTools/index.html). University at Buffalo.  Buffalo, New York. <br> <http://github.com/trinker/qdapTools>
    
Rinker, T. W. (2014). embodied: Embodiment related analysis tools.  University 
at Buffalo.  Buffalo, New York. <br> <http://github.com/trinker/embodied>
...
Buffalo.  Buffalo, New York. <br> <http://github.com/trinker/qdap>

Rinker, T. W. (2013). [reports: Package to Assist in Report
Writing](http://cran.r-project.org/web/packages/reports/index.html). University 
at Buffalo. Buffalo, New York. <br> <http://github.com/trinker/reports>

Rinker, T. W. & Kurkiewicz, D. (2013). pacman: Package Management Tools for R. 
University at Buffalo. Buffalo, New York. <http://github.com/trinker/pacman>

Rinker, T. W. & Aloe, A. M. (2013). metaDAT: Meta-analysis data 
management tool. version 0.1.0. University at Buffalo. Buffalo, New York. 
<http://github.com/trinker/metaDAT>
