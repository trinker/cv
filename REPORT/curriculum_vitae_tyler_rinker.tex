...
\vspace{-.1275in}
\begin{bibsection}
    \item Shanahan, L. E., Tochelli, A. L., \& Rinker, T. W. (revise and resubmit). Video study group reflection conversations: An analysis of inservice teachers' patterns of verbal interactions. \emph{Journal of the Learning Sciences}. Manuscript submitted for publication.
    
    \item McVee, M. B., McGrath, K., \& Rinker, T. W. (revise and resubmit). A phenomenological study of narrative interviews with parents of struggling readers: Bringing parent voices into the academy. \emph{Research Reading Quarterly}. Manuscript submitted for publication.
\end{bibsection}
