...
`r HS(3)` Ph.D., [*Major*: Curriculum, Instruction, & the Science of Learning](http://gse.buffalo.edu/programs/cisl), *Expected:* Summer 2015     
`r HS(3)` [*Concentration*: Reading Educations](http://gse.buffalo.edu/programs/cisl/reading)     
`r HS(3)` Thesis Topic: *Graphical discourse analysis: Data visualization as a tool for analyzing classroom discourse*    
...
`r HS(3)` Certification: New York State, School Building Leader    

`r HS(3)` M.S., [Childhood & Early Childhood Curriculum & Instruction](http://www.buffalostate.edu/gradprog.xml?bpid=27), Spring 2007       
`r HS(3)` Certification: New York State, Pre Kindergarten - Grade 6      
